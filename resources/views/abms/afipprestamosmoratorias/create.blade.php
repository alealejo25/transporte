...
@section('contenido')
	<div class="row">
		<div class="col-lg-6 col-lg-6 col-lg-6 col-xs-12">
			<h3>Nuevo Registro de Moratorias/Plan de Pago AFIP</h3>
			...
			@endif	
 			{!!Form::open(array('url'=>'abms/afipprestamosmoratorias','method'=>'POST','autocomplete'=>'off','enctype'=>'multipart/form-data'))!!} 
			...
			<div class="Form-group" >
				...
				<select name="impuesto" id="impuesto" class="form-control">
					<option value="">Selecccione un Impuesto</option>
