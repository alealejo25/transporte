...
@section('contenido')
	<div class="row">
		<div class="col-lg-6 col-lg-6 col-lg-6 col-xs-12">
			<h3>Nuevo Registro de Categorias de Choferes</h3>
			...
			@endif	
 			{!!Form::open(array('url'=>'abms/categoria','method'=>'POST','autocomplete'=>'off','enctype'=>'multipart/form-data'))!!} 
			{{Form::token()}}
			...
			<div class="Form-group">
				<br/>
				<a href="/abms/categoria"><button class="btn btn-success">Regresar</button></a>
			</div>
