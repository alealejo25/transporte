...
@section('contenido')
	<div class="row">
		<div class="col-lg-6 col-lg-6 col-lg-6 col-xs-12">
			<h3>Nuevo Registro de Gremios</h3>
			...
			@endif	
 			{!!Form::open(array('url'=>'abms/gremio','method'=>'POST','autocomplete'=>'off','enctype'=>'multipart/form-data'))!!} 
			{{Form::token()}}
			...
			<div class="Form-group">
				<br/>
				<a href="/abms/gremio"><button class="btn btn-success">Regresar</button></a>
			</div>
