...
@section('contenido')
	<div class="row">
		<div class="col-lg-6 col-lg-6 col-lg-6 col-xs-12">
			<h3>Nuevo Registro de Cuentas Bancarias Propias</h3>
			...
			@endif	
 			{!!Form::open(array('url'=>'abms/cuentasbancariaspropias','method'=>'POST','autocomplete'=>'off','enctype'=>'multipart/form-data'))!!} 
