...
@section('contenido')
	<div class="row">
		<div class="col-lg-6 col-lg-6 col-lg-6 col-xs-12">
			<h3>Movimientos de Caja - BOLETERIA TAFI VIEJO</h3>
			...
			@endif	
 			{!!Form::open(array('url'=>'boltafi/cajas/guardarmovimiento','method'=>'POST','autocomplete'=>'off','enctype'=>'multipart/form-data'))!!} 
			...
			<div class="Form-group">
				...
				<select name="tipo" id="tipo" class="form-control">
							...
							<option value="INICIAR CAJA">INICIAR CAJA</option>
				</select>
			</div>
