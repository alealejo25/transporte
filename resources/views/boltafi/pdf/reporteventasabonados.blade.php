...
<head>
    ...
    <title>Reporte de Ventas de Abonos x Abonados</title>
    <style>
        body {
            margin: 0;
...
<body>
    ...
    <h2>Informe de Ventas x Abonado -  La Nueva Fournier - BOLETERIA TAFI VIEJO</h2>

@foreach ($abonado as $datos)
<h3>Abonado: {{$datos->apellido}},{{$datos->nombre}}</h3>
<h3>DNI: {{$datos->dni}}</h3>
@endforeach 
