            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod6a" class="final" placeholder="Final Codigo 6a" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod6b" class="final" placeholder="Final Codigo 6b" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod7a" class="final" placeholder="Final Codigo 7a" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod7b" class="final" placeholder="Final Codigo 7b" style="text-align:right" type="text" size="4" required>
                ...
                <div class="p-3 border rounded shadow-sm">
                	<label for="">COD 8a</label>
                     <div class="contenedor">
                        ...
                        <input name="fincod8a" class="final" placeholder="Final Codigo 8a" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod8b" class="final" placeholder="Final Codigo 8b" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod10a" class="final" placeholder="Final Codigo 10a" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod10b" class="final" placeholder="Final Codigo 10b" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod12a" class="final" placeholder="Final Codigo 12a" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod12b" class="final" placeholder="Final Codigo 12b" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod14a" class="final" placeholder="Final Codigo 14a" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod14b" class="final" placeholder="Final Codigo 14b" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod15a" class="final" placeholder="Final Codigo 15a" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod15b" class="final" placeholder="Final Codigo 15b" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod18a" class="final" placeholder="Final Codigo 18a" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod18b" class="final" placeholder="Final Codigo 18b" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod21a" class="final" placeholder="Final Codigo 21a" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod21b" class="final" placeholder="Final Codigo 21b" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod23a" class="final" placeholder="Final Codigo 23a" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod23b" class="final" placeholder="Final Codigo 23b" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod27a" class="final" placeholder="Final Codigo 27a" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod27b" class="final" placeholder="Final Codigo 27b" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod30a" class="final" placeholder="Final Codigo 30a" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod30b" class="final" placeholder="Final Codigo 30b" style="text-align:right" type="text" size="4" required>
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="fincod32b" class="final" placeholder="Final Codigo 32b" style="text-align:right" type="text" size="4" required>
