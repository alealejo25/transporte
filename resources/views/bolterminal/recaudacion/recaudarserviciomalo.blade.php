...
@section('contenido')
	<div class="row">
		<div class="col-lg-4 col-lg-4 col-lg-4 col-xs-12">
            ...
            <form method="POST" id="saveForm" action="{{ url('bolterminal/guardarrecaudacionchofer/') }}" method="POST">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cantidad6a" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
                        <input name="cod6a" class="pesos" placeholder="Total Recaudado" style="text-align:right" type="text" readonly  tabindex="-1"size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod6b" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod7a" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod7b" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly  tabindex="-1" size="4">
                ...
                <div class="p-3 border rounded shadow-sm">
                	<label for="">COD 8a</label>
                     <div class="contenedor">
                        ...
                        <input name="cod8a" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod8b" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4"> 
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod10a" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod10b" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod12a" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod12b" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod14a" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod14b" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod15a" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod15b" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod18a" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod18b" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod21a" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod21b" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod23a" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod23b" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod27a" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod27b" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod30a" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod30b" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod32a" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="cod32b" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="abonosa" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
            ...
            <div class="col-6 col-md-2">
                <div class="p-3 border rounded shadow-sm">
                    ...
                    <div class="contenedor">
                        ...
                        <input name="abonosb" class="resultado" placeholder="Cantidad de Boletos" style="text-align:right" type="text" readonly tabindex="-1" size="4">
...
@endforeach
			...
			<div class="Form-group">
				<button type="button" class="btn btn-primary" id="showConfirmModal">Guardar</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="confirmSave">Sí, guardar</button>
            </div>
        </div>
    </div>
</div>		
...
<script>
        ...
        // Mostrar el modal cuando se haga clic en "Guardar"
    $("#showConfirmModal").click(function () {
