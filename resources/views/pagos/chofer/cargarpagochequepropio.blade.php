	...
	<div class="row">
		<div class="col-lg-6 col-lg-6 col-lg-6 col-xs-12">
 		...
 		<!--	{!!Form::open(array('url'=>'guardartransferencia','autocomplete'=>'off','enctype'=>'multipart/form-data'))!!} -->
				{!!Form::open(['route' => 'guardarpagochequepropiochofer','method'=>'POST'])!!}
			{{Form::token()}}
			...
			<div class="Form-group">
				...
				<input type="date" name="fecha" id="fecha" class="form-control {{$errors->has('fecha')?'is-invalid':''}}" placeholder="Fecha del Cheque..." value="{{old('fecha')}}">
