	...
	<div class="row">
		<div class="col-lg-6 col-lg-6 col-lg-6 col-xs-12">
 		...
 		<!--	{!!Form::open(array('url'=>'guardartransferencia','autocomplete'=>'off','enctype'=>'multipart/form-data'))!!} -->
				{!!Form::open(['route' => 'guardarpagotransferencia','method'=>'POST'])!!}
			{{Form::token()}}
			...
			<div class="Form-group">
				<label for="cuentabancariapropia_id">Seleccione el importe del Cheque de tercero</label>
			...
			<div class="Form-group">
				<br/>
				<a href="/pagos/transferencia"><button class="btn btn-success">Regresar</button></a>
			</div>
