            ...
            <div class="col-12 layout-spacing">
                <div class="widget-content-area">
                    <div class="widget-one">
                        ...
                        <!--TITULO-->
                        <h4 class="text-center mb-5">Reporte Articulos por Cliente </h4>
                        {!!Form::open(['route' => 'reportearticulos','method'=>'POST'])!!}
						{{Form::token()}}
                        <!--ENCABEZADO-->
                        <div class="row">
							 <div class="col-sm-12 col-md-2 col-lg-2">Seleccione Cliente
